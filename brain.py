...
class Dqn():
    ...
    def __init__(self , input_size,nb_action ,gama):
       self.gama=gama
       self.reward_window = []
    ...
    def select_action(self, state):
        probs = f.softmax(self.model(Variable(state,volatile=True))*5)
    ...
    def learn(self , batch_state,batch_next_state,batch_reward , batch_action):
        ...
        target = self.gama*next_output + batch_reward
